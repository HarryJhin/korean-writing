...
| R2 번역투 | 무생물 주어, 수동문 직역, 과잉 명사화, `-의` 연쇄, 이중 조사, 대명사 직역, 연결어미 뒤 쉼표 | 스킬 판단 + S2 밀도 카운트 |
| R3 문장 구조 | 내포·삽입 깊이, 단문 일변도, 쉼표 긴 절 사슬 | 스킬 판단 |
| R4 AI슬롭 회피 | 슬롭 어휘군(결산·과장·hype·공식구), 형식명사, 문두 접속사, hedging, 균일 리듬, 불필요 주어 | 스킬 판단 + S2 밀도 카운트 |
| R5 일관성·정직 | 존댓말 등급 일관, 날조 금지 | 스킬 판단 |
| R6 글 구성·전개 | 장면 도입, 소제목 레지스터, 병렬 틀, 비유, 결론 응축 | 스킬 판단 |
| R7 서식·강조 절제 | 볼드·따옴표·괄호 병기·인덱싱·콜론 헤딩·불릿 남용 | 스킬 판단 |

R2·R4 일부 마커는 `lib/prose-checks.js`가 S2 밀도로 센다(게이트 아님, 교정 스킬 참고용).
수입 규칙의 심사 기록은 [docs/im-not-ai-갭-심사.md](./docs/im-not-ai-갭-심사.md) 참조.
...
MIT([LICENSE](./LICENSE)). 문체 규칙의 귀속 고지는 [NOTICE.md](./NOTICE.md)에 있다.
